...
class Const {
     ...
     */
    static public final String APP_VER = "19.0.0.modules-draft5-SNAPSHOT"

    /**
     * The app build time as linux/unix timestamp
     */
    static public final long APP_TIMESTAMP = 1549910961880

    /**
     * The app build number
     */
    static public final int APP_BUILDNUM = 5077
